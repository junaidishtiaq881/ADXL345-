...
void adxl_init (void)
{
	...
	adxl_write (ADXL345_THRESH_TAP, 0x20);  // setting a tap threshold to 0x20
	adxl_write (ADXL345_TAP_DURATION, 0x50); // adjusting a tap duration of tap detection
	adxl_write (ADXL345_TAP_AXES, 0x07);    // enabling tap detection on all axes
	adxl_write (ADXL345_INT_ENABLE, 0x40);   // enabling single tap interrupt
